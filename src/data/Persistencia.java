...
public class Persistencia {
    ...
    private static void inicializarPaises(){
        paises.add(new Pais("Argentina","345"));
        paises.add(new Pais("Uruguay","574"));
        paises.add(new Pais("Alemania","123"));
        paises.add(new Pais("Brasil","983"));
        paises.add(new Pais("Mexico","928"));
    }
    ...
    public static void agregarAnimal(Mamifero nuevo) {
        animales.add(nuevo);
    }
